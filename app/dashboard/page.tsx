    ...
    return (
        <div className="max-w-6xl mx-auto p-8 font-sans min-h-[80vh] flex flex-col">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 relative z-10">
                ...
                {/* TOOL 1: CATÁLOGO QR */}
                <Link href="/dashboard/tools/tool-1-QR" className="bg-slate-900 p-8 rounded-3xl border border-slate-800 shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 group flex flex-col h-full overflow-hidden">
                ...
                {/* TOOL 2: COMANDAS */}
                <Link href="/dashboard/tools/tool-2-pedidos" className="bg-slate-900 p-8 rounded-3xl border border-slate-800 shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 group flex flex-col h-full overflow-hidden">
                ...
                {/* PRÓXIMAMENTE */}
                <div className="bg-slate-900 p-8 rounded-3xl border border-slate-800 border-dashed flex flex-col h-full opacity-60">
